  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-greenBlue text-primary-foreground hover:bg-greenBlue/90 border-greyBlue border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-greenBlue hover:bg-slate-100", 
        secondary: "bg-greenBlue text-primary-foreground hover:bg-blue/90 border-greyBlue border-b-4 active:border-b-0",
        ...
        superOutline: "bg-white text-blue hover:bg-slate-100",
        ...
        sidebarOutline: "bg-peach/15 text-red-400 border-red-400 border-2 hover:bg-peach/20 transition-none",
      },
      size: {
